# Notas de lançamento do DevTools 2.34.1
...
* Corrigido an issue preventing DevTools from connecting to Flutter apps that
  are not launched from Flutter Tools. - [#6848](https://github.com/flutter/devtools/issues/6848)
* Melhorado performance of the FlatTable. -
...
* Adicionar a setting to include CPU samples in the Timeline. -
...
* Removido the legacy trace viewer.
...
* Atualizado the Perfetto trace viewer build. -
...
* Adicionado a loading message to show when refreshing the timeline. - [#7463](https://github.com/flutter/devtools/pull/7463)

    ![Loading message](/tools/devtools/release-notes/images-2.34.1/7463-overlay.png "Loading message")

## Atualizações do Memory

* Habilitado export of snapshots and improved snapshotting performance. -
...
* Corrigido failures during disconnect in tracing. - [#7440](https://github.com/flutter/devtools/pull/7440)
...
* Melhorado Network profiler performance. - [#7266](https://github.com/flutter/devtools/pull/7266)
* Corrigido a bug where selected pending requests weren't
  refreshing the tab once updated. - [#7266](https://github.com/flutter/devtools/pull/7266)
* Corrigido the JSON viewer so multiline strings are visible in their row, and
  through a tooltip. - [#7389](https://github.com/flutter/devtools/pull/7389)
* Corrigido JsonViewer where all of the
