...
* Adicionado a new feature for deep link validation,
  supporting deep link web checks on Android. - [#6935](https://github.com/flutter/devtools/pull/6935)
* Adicionado the basic plumbing to allow connections to a Dart Tooling Daemon. - [#7009](https://github.com/flutter/devtools/pull/7009)
...
* Adicionado link to package directory documentation,
...
* Corrigir bug where widgets owned by the Flutter framework were
...
* Adicionado hover cards to show sampling rate for the item in drop down. - [#7010](https://github.com/flutter/devtools/pull/7010)
...
* Adicionado scrollbar to details pane. - [#6917](https://github.com/flutter/devtools/pull/6917)
...
* Corrigido a couple bugs preventing Dart server apps from
