---
ia-translate: true
title: Diretrizes de Marca Flutter
description: >
  As diretrizes que regem o uso das marcas registradas e assets do Flutter.
...
registradas do Flutter por membros da comunidade de desenvolvedores que obtiveram nosso
consentimento para usar as marcas registradas de acordo com os [Termos de Serviço do Flutter](/tos).
Essas diretrizes garantirão que as marcas registradas do Flutter sejam usadas de uma
maneira que promova a missão do Google de fornecer um SDK gratuito e de código aberto
...
O uso das marcas registradas do Flutter que não é expressamente permitido por estas
diretrizes é proibido sem permissão por escrito do Google.

Os assets oficiais do Flutter e diretrizes adicionais sobre a representação da marca
...
Essas diretrizes não restringem seu direito de usar o nome "Flutter"
...
Você pode usar as marcas registradas do Flutter em seu site pessoal,
blog pessoal ou conta de mídia social para mostrar seu apoio ao Flutter SDK,
...
sites ou blogs pessoais, isso significa que você não deve usar as marcas
registradas do Flutter como o elemento principal da página web (por exemplo, no cabeçalho
da página web ou no título do blog). No caso de contas de mídia
social, isso significa que você não deve usar as marcas registradas do Flutter no
plano de fundo, na sua imagem de perfil ou no seu nome de usuário de mídia social.

## Regras Específicas para Uso Adequado das Marcas Registradas do Flutter
...
* Use o nome "Flutter" como adjetivo, nunca como substantivo ou verbo,
  e nunca na forma plural ou possessiva.
* Use um termo genérico seguindo o nome "Flutter", por exemplo,
  "o Flutter SDK" ou "o toolkit de UI Flutter".
* Distinga o nome "Flutter" do texto ao redor de alguma forma.
  Capitalize a primeira letra, capitalize ou italicize toda a marca,
...
* Use o símbolo de marca registrada <sup>TM</sup> para a primeira ou mais proeminente
  vez que o nome "Flutter" aparecer em texto em seu site ou blog.
...
* Inclua o seguinte texto perto do primeiro ou mais proeminente uso das
  marcas do Flutter em seu site ou blog: "Flutter e o logotipo relacionado são
...
* Mantenha alguma distância entre as marcas registradas do Flutter e quaisquer outras marcas registradas,
  logotipos ou ícones que sejam exibidos na página web.

**NÃO FAÇA:**

* Não altere, distorça ou modifique as marcas registradas do Flutter de forma alguma.
  Isso inclui variar a grafia do nome "Flutter", ou exibir
...
* Não combine o nome Google com o nome "Flutter" para formar uma marca
  unitária (por exemplo, não use as frases "Google Flutter" ou "Flutter do Google").
...
* Não exiba as marcas registradas do Flutter de uma maneira que seja enganosa,
  injusta, difamatória, infratora, libelosa, depreciativa, obscena ou
  de outra forma censurável ao Google.
* Não use as marcas registradas do Flutter em ou em conexão com a venda de
  quaisquer bens ou serviços que não sejam software (por exemplo, mercadorias como roupas,
  canetas e adesivos).
...
1. Grupos de usuários locais do Flutter podem: (i) usar o nome "Flutter"
   ...
   "Flutter + [nome do país/cidade]" (por exemplo, "Flutter França"); e (ii)
   ...
   as cores azul, branco e vermelho), desde que o logotipo Flutter esteja
...
2. Você pode usar as marcas registradas do Flutter como parte do nome de uma newsletter
   ou conteúdo relacionado da comunidade (por exemplo, cursos de treinamento Flutter,
   fóruns da comunidade Flutter) cujo propósito é promover o uso do
   Flutter SDK por membros da comunidade de desenvolvedores.
   Onde as marcas registradas do Flutter são exibidas em um site como parte de um
   ...
   Onde as marcas registradas do Flutter são exibidas em uma conta de mídia social
...
3. <b>[Eventos Flutter Não Oficiais]</b> Você pode usar as marcas registradas do Flutter como parte do nome
   de um evento comunitário (por exemplo, conferência), mas certifique-se de incluir o seguinte aviso
   ...
   [Título do evento] não é afiliado ou patrocinado pelo Google LLC."
