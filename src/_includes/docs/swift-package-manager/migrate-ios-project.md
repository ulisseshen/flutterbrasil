...
1. Execute o app iOS usando a CLI do Flutter.

   Se seu projeto iOS ainda não tiver integração com o Swift Package Manager, a
   ...
   arquivos `ios/Runner.xcodeproj/project.pbxproj` e
