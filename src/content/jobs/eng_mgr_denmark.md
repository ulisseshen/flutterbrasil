...
* Desenvolver a perspectiva técnica de médio prazo e roadmap dentro do escopo de sua(s) equipe(s) (frequentemente múltiplas). Evoluir o roadmap para atender requisitos futuros antecipados e necessidades de infraestrutura.
...
* 3 anos de experiência em função de liderança técnica; supervisionando
  projetos, com 2 anos de experiência em gestão de pessoas,
  função de supervisão/liderança de equipe.
...
Por favor, candidate-se via [esta página do Google Careers](https://www.google.com/about/careers/applications/jobs/results/115475745324573382-engineering-manager).
