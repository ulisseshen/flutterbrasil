...
1. Abra seu app (`macos/Runner.xcworkspace`) no Xcode.
...
1. Navegue até `macos/Flutter/ephemeral/Packages/FlutterGeneratedPluginSwiftPackage`
...
1. Clique no botão <span class="material-symbols" translate="no">add</span>
   e selecione **New Run Script Action** no menu.
...
1. Mude o **Provide build settings from** para o alvo `Runner`.
